...
function GbessiaTele() {
    return (
        <>
            <Navbar></Navbar>
            <PageInfoSection title={"Gbessia Télé"} desc={"Lorem ipsum dolor sit amet consectetur adipisicing elit. Assumenda, et."}></PageInfoSection>
            <BanniereSection></BanniereSection>
            <section className="ytLinks">
                <div className="top">
                    <iframe src="https://www.youtube.com/embed/g_eKT-07DLk?si=dFdeWfBU8UqLTzJ2" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                </div>
